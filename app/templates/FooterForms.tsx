...
export const FooterForms = (): JSX.Element => {
    ...
    <div className="fixed left-0 bottom-0 dark:bg-zinc-900 bg-zinc-300 shadow-lg shadow-zinc-900 dark:shadow-zinc-500 min-w-full">
      <div className="px-10 py-3 flex justify-between">
        <label
          ...
          className="relative block h-8 w-14 rounded-full bg-gray-400 transition-colors [-webkit-tap-highlight-color:_transparent] has-checked:bg-lime-500 dark:bg-gray-600 dark:has-checked:bg-lime-600"
        >
          <input
            type="checkbox"
            id="ChangeViewToEdit"
