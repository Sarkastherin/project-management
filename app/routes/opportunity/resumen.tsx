...
function DataField({
  ...
  return (
    <div className="flex justify-between gap-4 text-sm">
      ...
      <span className={`bg-zinc-200/50 dark:bg-zinc-700/50 rounded-lg w-full px-4 py-1.5 min-h-8`}>{value}</span>
    </div>
  );
}
        ...
        <div className="flex flex-col gap-4 mt-4">
          <Card>
            <div className="flex flex-col gap-2">
              ...
              <DataField label={"Alcance"} value={selectedOpportunity?.scope || ''} />
            </div>
          </Card>
          <Card>
            <div className="flex flex-col gap-2">
              ...
              <span className="px-5 py-0.5 w-full">
                <BadgeStatus variant={selectedOpportunity?.status || "No status"}>
